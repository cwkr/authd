...
func (o *twoFactorAuthSetupHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if uid, active, _ := o.sessionManager.CheckSession(r, client); active {
		...
		if r.Method == http.MethodPost {
			var code = strings.TrimSpace(r.PostFormValue("code"))
...
func TwoFactorAuthSetupHandler(sessionManager sessions.SessionManager, clientStore clients.Store, otpauthStore otpauth.Store, basePath, version, issuer string) http.Handler {
